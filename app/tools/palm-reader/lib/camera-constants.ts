...
/** Confidence threshold (0-1) for auto-capture readiness. Maps to 75% quality. */
 ...
 */
export const STABILITY_DELTA_THRESHOLD = 5;

/**
 * Number of consecutive stable frames required before auto-capture triggers.
 * At ~30fps, 15 frames = ~500ms of holding still.
 */
export const STABLE_FRAMES_REQUIRED = 15;
